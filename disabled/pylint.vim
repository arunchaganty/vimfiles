...
CompilerSet makeprg=(pylint\ -rn\ --msg-template='{path}:{line}:\ [{msg_id},\ {obj}]\ {msg}'\ %)
"CompilerSet makeprg=(echo\ '[%]';\ pylint\ %)
...
CompilerSet efm=%f:%l:\ [%t%n,\ %s]\ %m
" CompilerSet efm=%f:%l\\\ \[E,\ %*\]\ %m 
" %+P[%f],%t:\ %#%l:%m,%Z,%+IYour\ code%m,%Z,%-G%.%#
